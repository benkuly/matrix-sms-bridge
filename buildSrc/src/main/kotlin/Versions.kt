object Versions {
    ...
    const val matrixSDK = "0.4.0.SNAPSHOT" // https://github.com/benkuly/matrix-spring-boot-sdk/releases
    const val clikt = "3.0.1" // https://github.com/ajalt/clikt/releases
    const val ant = "1.10.9" // https://ant.apache.org/antnews.html
    const val libphonenumber = "8.12.11" // https://github.com/google/libphonenumber/releases
}